...
export class UIManager extends EventEmitter {
  ...
  private debugEnabled: boolean = true; // Always enabled by default
  ...
  private createDebugPanel(): void {
    ...
    this.debugPanel.style = "display: flex !important;z-index: 999999; color: black; position: absolute;    "
    this.debugPanel.className = 'debug-panel'; // Always visible
    ...
    // No toggle button needed since debug panel is always visible
  }

  /**
   * Toggle debug panel visibility (kept for API compatibility)
   */
  public toggleDebugPanel(): void {
    // Debug panel is always visible now, so this method does nothing
    return;
  }
